...
function on_gui()
  ...
  if is_in_match then
    ...
    if spectator_settings.display_hitboxes == 2 or spectator_settings.display_hitboxes == 3 then
      util_draw.draw_hitboxes(player_objects[1].pos_x, player_objects[1].pos_y, player_objects[1].flip_x,
        player_objects[1].boxes)
    ...
    if spectator_settings.display_hitboxes == 2 or spectator_settings.display_hitboxes == 4 then
      util_draw.draw_hitboxes(player_objects[2].pos_x, player_objects[2].pos_y, player_objects[2].flip_x,
        player_objects[2].boxes)
